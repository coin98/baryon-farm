...
library AdvancedVRC25 {
  ...
  function safeApprove(IVRC25 token, address spender, uint256 amount) internal {
  ...
  function safeTransfer(IVRC25 token, address to, uint256 amount) internal {
  ...
  function safeTransferFrom(IVRC25 token, address from, address to, uint256 amount) internal {
